...
// Game constants
const GRAVITY = 0.45;        // Reverted to original
const FLAP_FORCE = -11;     // Reverted to original
const PIPE_SPEED = 3;        // Reverted to original
...
function render() {
    ...
    if (marioSprite.complete) { // Ensure image is loaded
        ...
        ctx.fillRect(mario.x, mario.y, mario.width, mario.height); // Reverted fallback drawing position
    }
}
...
// Check collision between two rectangles (reverted)
function checkCollision(rect1, rect2) {
    // Reverted simple AABB collision
    return (
